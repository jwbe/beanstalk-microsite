...
Beanstalk uses the Kochava SDK provided by Kochava Inc as a data processor to monitor effectiveness of different marketing activities. Device specific information such as the hardware model, operating system and version, unique device identifiers and data about usage of our services may be shared with Kochava for them to process anonymously on our behalf.  
...
KidStart and Beanstalk use Google Analytics, a web analytics service provided by Google, Inc. ("Google") and tools from Firebase, a mobile development platform also provided by Google. Google Analytics also uses cookies so that KidStart can analyse how users use the website. The information generated by the cookie about your use of the website (including your IP address) will be transmitted to and stored by Google on servers in the United States. Google will use this information for the purpose of evaluating your use of the website, compiling reports on website activity for KidStart and providing other services relating to website activity and internet usage. Google may also transfer this information to third parties where required to do so by law, or where such third parties process the information on Google's behalf. Google will not associate your IP address with any other data held by Google. Firebase is used by KidStart to monitor how the app is used, identify and report any crashes and deliver app notifications. Information on how Google processes data can be found at <a href="www.google.com/policies/privacy/partners" target="_blank" rel="noopener noreferrer">www.google.com/policies/privacy/partners</a>. 
