...
const Confirmation = () => (
  <div className={Theme.Wrapper}>
    ...
    <p className={Theme.Text}>
      <strong>Now just download the Beanstalk app and  register with the same email you just gave us.</strong>  <br/>It takes just a couple of minutes to open an account.
    </p>
