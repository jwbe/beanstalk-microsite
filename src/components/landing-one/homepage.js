    ...
    <main className={styles.Homepage_main}>
      <header className={styles.Homepage_header}>
        ...
        <div className={styles.Homepage_header_content}>
          ...
          <p className={styles.Homepage_subheading}>
            The Beanstalk savings app helps families work together <br className={styles.Homepage_heading_lineBreak}/> to give their kids the best possible launch into adult life. <br/> <span className={styles.Homepage_specialCTA}>Get the app NOW and start saving today!</span>
          </p>
          <AppBadges/>
        </div>
      ...
      <Section className={`${styles.Homepage_section} ${styles.Homepage_section___firstSection}`}>
        ...
        <Column className={styles.Homepage_column___copy}>
          <Point
            ...
            <p>
              With no minimum or regular contribution required, the Beanstalk savings app makes investing for your kids easy whether it is £10 or £1000, collect free savings on your shopping and round up your purchases to automatically save.
            </p>
      ...
      <Section className={styles.Homepage_section}>
        <Column className={`${styles.Homepage_column___copy}`}>
          <Point
            icon={iconFamily}
            heading="The UK's family savings app">
            <p>
