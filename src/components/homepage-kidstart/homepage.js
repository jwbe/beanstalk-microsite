      ...
      <header className={styles.Homepage_header}>
        ...
        <div className={styles.Homepage_header_content}>
          ...
          <p className={styles.Homepage_subheading}>
            The new app from KidStart that invests in your kids. Linked to your KidStart account, <br className={styles.Homepage_heading_lineBreak}/> Beanstalk helps families work together to build a pot of money <br className={styles.Homepage_heading_lineBreak}/>to give their kids the best possible launch into adult life
          </p>
          <AppBadges/>
        </div>
