...
const SignUpPage = () => {
  return (
    <>
      ...
      <li>Offer available until 23:59 11th April 2021.</li>

      <li>Full Beanstalk T&Cs can be viewed here. Beanstalk reserve the right to withdraw or amend this offer at any time.</li>
      </SignUp>
    </>
  )
}
